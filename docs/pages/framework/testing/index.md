...
For specific test configuration including environment setup and profile management, see the [Configuration guide](/framework/configuration/).
...
## Cairo Testing Cheat Codes

Cairo provides several testing cheat codes that allow you to manipulate various execution context variables like block number, caller address, and timestamps during testing.
For detailed examples and comprehensive coverage of all available cheat codes, see the [Cairo Testing Cheat Codes guide](/framework/testing/cheat-codes/).
