...
<p className="text-xl">
    Equipped with a Cairo architecture, development sequencer, blazingly fast
    and automatic indexing with CLI tooling to match. Versatile enough to
    support a wide range of onchain applications, from simple NFT projects to
    the most complex onchain games.
</p>
