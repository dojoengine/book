...
description: Create your first Dojo project from scratch and deploy it locally. Learn basic ECS concepts, project structure, and how to interact with your deployed game.
---
