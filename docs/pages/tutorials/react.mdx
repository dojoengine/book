...
For a more detailed explanation of Dojo concepts and architecture, see the [Dojo Starter tutorial](/tutorials/dojo-starter).
Here are some additional next steps to take:
