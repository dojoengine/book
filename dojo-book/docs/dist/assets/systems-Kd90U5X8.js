...
`,n.jsxs(e.p,{children:["Systems play a pivotal role in your world's logic, directly mutating its component states. It's important to understand that to enact these mutations, a system needs explicit permission from the ",n.jsx(e.a,{href:"/cairo/models",children:n.jsx(e.code,{children:"models"})})," owner."]}),`
...
`,n.jsxs(e.p,{children:["Every system function starts with a ",n.jsx(e.a,{href:"/cairo/world",children:n.jsx(e.code,{children:"world"})})," address as its initial parameter. This design permits these functions to alter the world's state. Notably, this structure also makes systems adaptable and reusable across multiple worlds!"]}),`
...
`]})]})}function d(s={}){const{wrapper:e}={...i(),...s.components};return e?n.jsx(e,{...s,children:n.jsx(a,{...s})}):a(s)}export{d as default,r as frontmatter};
