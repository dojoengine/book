...
For game-specific primitives and geometric operations, consider also exploring [Origami](./origami), which provides specialized utilities for game development in Dojo.
