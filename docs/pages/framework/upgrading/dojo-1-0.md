...
The full API for model operations can be found in the [Model API reference](../models/api).
...
For comprehensive permission management documentation, see the [World Permissions guide](../world/permissions).
...
The configuration of your dojo project is now fully managed by a profile-based configuration system alongside the `Scarb.toml` manifest file.
This eases the profile management and regroups all the functionalities at the same place.

You can find detailed information about the configuration file in the [Configuration guide](../configuration).
...
As you remember, Dojo uses profile-based configuration.
...
# useful for entity ID computation too.
...
# as you remember the keys are used to identify the entity ID
...
- The Model API has changed, please refer to the new [Model API reference](../models/api).
