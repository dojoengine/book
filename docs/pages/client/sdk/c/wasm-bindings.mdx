...
:::info
[WebAssembly](https://webassembly.org/) (WebAssembly) is a binary format that allows high-performance code (like Rust) to run in web browsers and Node.js at near-native speeds.
...
# Build WebAssembly module for web clients
...
Queries Controller account information.
...
Use these to execute game transactions, manage player accounts, and handle cryptographic operations like signing and verification.
...
const hash = poseidonHash(["0x123...", "0x456..."]);
```
