...
// Systems (Logic)
fn move(entity_id: u32, direction: Direction) {
    // Moves any entity with Position component
}

fn fight(attacker_id: u32, target_id: u32) {
    // Handles combat between any entities with Health components
}
```
...
![world-map](/architecture/world-map.png)
...
- **Plan your namespaces** - Organize resources logically
...
<div className="grid grid-cols-2 gap-8">
  ...
  <LinkCard
    ...
    link="/framework/world/systems"
  />

  <LinkCard
    title="Authorization"
    description="Master the permission system to secure your application."
