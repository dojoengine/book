...
Katana is a high-performance sequencer for local development and testing you can spin up with a single command.
...
For comprehensive coverage of AI skills installation and available skills, see the [Installation guide](/installation).
