...
description: "Create your first Dojo project from scratch and deploy it locally. Learn basic ECS concepts and get your development environment running."
---

# Your First Dojo App

In this tutorial, you will create your first Dojo project from scratch and deploy it locally.
By the end, you will have a working game where you can spawn and move a character using a browser-based client.
...
Let us examine the key `contracts/` files to understand what we are building:
...
Now let us get the development tools running.
You will run three tools simultaneously, each in its own terminal:
...
Keep this running - it is your local blockchain.
...
In a third terminal you will start Torii, Dojo's indexer:
...
Reading this output, you will see that Torii has set up some local endpoints, which the client will use to fetch game state.
You will also see that Torii has registered the game models `Moves` and `Position` we saw earlier, within the `di` namespace.
...
Now let us test your game!
First, let us launch your game client:
...
:::info
Take a moment to appreciate what is happening under the hood.
...
**Congratulations, you have just created your first provable game with Dojo!**

## Understanding What Happened

Let us break down what you just accomplished:
