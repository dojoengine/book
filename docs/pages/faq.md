...
[Dojo](/overview) was created to solve problems the founders faced when building onchain games in Cairo.
...
Within the Dojo toolchain exists [Katana](/toolchain/katana) which is a high-performance sequencer, which is perfectly suited to Dojo games.
...
To get started with development, see the [installation guide](/installation).
