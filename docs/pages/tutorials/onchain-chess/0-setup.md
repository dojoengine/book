...
_Before starting recommend following the [`hello-dojo`](/tutorials/dojo-starter) chapter to gain a basic understanding of the Dojo game._
...
This is where our game logic/dojo contract will reside.
...
It should be noted that System functions are contract methods, by implication, rather than implementing the game logic in systems, we are implementing it in a dojo contract.
...
Congratulations!
You've completed the basic setup for building an on-chain chess game 🎉
