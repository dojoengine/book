...
This tutorial demonstrates deploying and interacting with a smart contract on Starknet using Katana, Starkli, and Scarb.
For ECS/Dojo-specific concepts and patterns, see the [Dojo Starter tutorial](../dojo-starter).
