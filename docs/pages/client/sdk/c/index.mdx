...
For detailed information about the implementation architecture and how dojo.c provides the foundation for all Dojo SDKs, see the [main SDK overview](/index).
