...
:::note
_I can think of no other edifice constructed by man as altruistic as a lighthouse._
_They were built only to serve._
...
For game-specific primitives and integration patterns with Dojo, see [Origami: Game Development Primitives](/libraries/origami).
