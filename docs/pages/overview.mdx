...
Cartridge offers [Slot](https://github.com/cartridge-gg/slot), a managed-service execution layer that lets you easily deploy and scale your provable applications.

[Read more about Slot in the installation guide](/installation)
