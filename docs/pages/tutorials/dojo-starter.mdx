...
- Explained how `#[dojo::contract]` are used to define contracts
- Explained how to inject the world into a contract
...
That compiled the models and contracts into artifacts that can be deployed.
Simple as that!
...
By running this command, you've executed the spawn contract, resulting in the creation of a new entity.
...
- Executed the `spawn` contract locally
...
Designed to manage hundreds of contracts and models, Dojo is equipped for expansive creativity.
So, what will you craft next?

<div className="grid grid-cols-2 gap-8">
    <LinkCard
        title="On-chain Chess"
        description="Build a complete chess game using Dojo."
        link="/tutorials/onchain-chess/README"
    />
    <LinkCard
        title="Explore Dojo"
