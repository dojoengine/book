...
For detailed configuration syntax and patterns, see the [Configuration guide](/framework/configuration).
...
For complete event definitions and usage, see the [World Events guide](/framework/world/events).
