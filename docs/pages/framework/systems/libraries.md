...
In order to instruct the Dojo toolchain that you have a library to use, you need to configure it in your [Dojo configuration file](/framework/configuration).
...
As you have already seen, the Dojo resources are identified by a resource selector, which is for contracts/Models/Events the poseidon hash of the namespace and the resource name.
