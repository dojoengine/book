...
- Deploy the contract.
- Interact with `spawn` function in the contract by providing white and black player's wallet addresses as inputs.
- Retrieve the game entity and piece entity created in the contract.
...
First, we will set up the players address and their colors.
...
If you are stuck, do not hesitate to ask questions at the [Dojo community](https://discord.gg/akd2yfuRS3)!
