...
// Connect to ToriiClient indexer for the specified world
...
Client functions connect your application to the Dojo world state via ToriiClient (the indexer).
...
| --------------------------------------------------------- | -------------------- | ---------------------------------------------- |
| `client_new(torii_url, world)`                            | `ResultToriiClient`  | Creates connection to ToriiClient indexer      |
