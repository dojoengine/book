...
This establishes the world_address for your project.
...
With your local world_address established, let's delve into indexing.
You can index the entire world.
To accomplish this we have to copy your `world_address` from the output of `sozo migrate`.
Now Open a new terminal and input this simple command that includes your own world_address:

```bash
torii --world 0xb4079627ebab1cd3cf9fd075dda1ad2454a7a448bf659591f259efa2519b18 --http.cors_origins "*"
```

Running the command mentioned above starts a [Torii indexer](/toolchain/torii) on your local machine.
This indexer uses SQLite as its database and is accessible at http://0.0.0.0:8080/graphql.
`Torii indexer` will automatically organize your data into tables, making it easy for you to perform queries using GraphQL.
...
- Indexed the world with Torii indexer
...
<div className="grid grid-cols-2 gap-8">
    <LinkCard
        ...
        description="Build a frontend for your Dojo game."
