...
description: Create your first Dojo project from scratch and deploy it locally
---
...
pub mod actions {
    ...
    fn move_random(ref self: ContractState) {
        // Use the Cartridge vRNG to move in a random direction
    }
}
```
...
For information about project configuration including the `dojo_dev.toml` file, see the [Project Configuration section](./understanding-the-toolchain#project-configuration) in Understanding the Toolchain.
...
For a comprehensive guide to setting up your development environment, see the [Development Environment Setup](./development-workflow#setting-up-your-development-environment) section in Development Workflow.
...
For a deeper understanding of these concepts, see [Understanding the Toolchain](./understanding-the-toolchain).
...
Continue to [Understanding the Toolchain](./understanding-the-toolchain) to learn more about the tools that make Dojo development possible, or explore the [Next Steps](./next-steps) guide for additional learning paths.
