...
For alternative deployment methods, see the [Slot deployment guide](../deploy-using-slot/main).
...
- Create Torii indexer with this command, replacing... - `SERVICE_NAME` can be the name of the game/dapp.
