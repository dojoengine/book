...
description: Create your first Dojo project from scratch and deploy it locally. Learn basic ECS concepts and the development workflow.
---
...
To understand how these tools work together, check out [Understanding the Toolchain](./understanding-the-toolchain).
...
In a third terminal you'll start [Torii](/toolchain/torii), Dojo's indexer:
