...
description: Learn about the Dojo toolchain - Katana, Torii, Sozo, and Saya
---
...
For a more detailed look at the development workflow, see the [development workflow guide](./development-workflow).
