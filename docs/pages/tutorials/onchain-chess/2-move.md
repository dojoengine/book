...
For detailed explanations of Dojo concepts like **Models**, **Systems**, and **World** state management, see the [Dojo Starter Guide](/tutorials/dojo-starter).
...
If you're stuck, do not hesitate to ask questions at the [Dojo community](https://discord.gg/akd2yfuRS3)!
