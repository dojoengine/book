...
For basic Katana deployments, see the [Katana deployment guide](/tutorials/katana-starkli-scarb).
...
- Create a Torii configuration file with your world address and RPC endpoint:
