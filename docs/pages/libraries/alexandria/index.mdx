...
Alexandria provides essential building blocks for Cairo and Starknet development, covering mathematics, data structures, algorithms, and utilities that complement Dojo's onchain game development framework.
For game-specific primitives and utilities, consider using [Origami](/libraries/origami) alongside Alexandria to get both general-purpose algorithms and specialized game development features.
...
For specialized game mathematics like algebraic operations on vectors and matrices, see [Origami's Algebra crate](/libraries/origami#algebra) which provides complementary game-focused mathematical primitives.
...
Alexandria complements Dojo's onchain game development framework by providing:
