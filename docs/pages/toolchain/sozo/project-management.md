...
For more details about binding generation architecture and options, see the [binding generation guide](./binding-generation).
...
katana --dev --dev.no-fee &   # Start local sequencer (see Katana guide)
sozo migrate                  # Deploy world and all resources
...
For more information about starting and configuring Katana, see the [Katana guide](/toolchain/katana).
