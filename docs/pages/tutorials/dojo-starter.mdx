...
When deploying and interacting with Dojo worlds, you'll need to set up proper environment variables to work with your local development network.

### Environment Variables Setup

Place the following environment variables in a `.env` file within your project directory:
...
This configuration allows your Dojo application to properly connect to the local Katana development network using pre-funded accounts for seamless testing and development workflows.
