...
The `#[key]` attribute tells Cairo that `player` is the Dojo entity identifier for these models.
...
For more details about these tools, see [Understanding the Toolchain](./understanding-the-toolchain).
...
For longer development sessions, you might want to streamline your workflow.
...
Create a simple script to start all tools at once.
...
> **Tip**: This automated approach is especially useful for larger projects with more complex development workflows.
