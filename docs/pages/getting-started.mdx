...
- Dojo toolchain (installation instructions provided here)
- SDKs: Libraries to interact with your onchain state

Follow this guide to install the CLI, then proceed to the guides and starters.

### Prerequisites

To work with Dojo, you need to have Git, Rust and Scarb installed on your PC to satisfy Dojo dependencies.
