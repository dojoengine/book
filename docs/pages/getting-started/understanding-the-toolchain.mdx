...
description: Learn about Katana, Torii, Sozo, and Saya - the core tools that power Dojo development.
---
...
For complete coverage of all commands and options, see the [Sozo documentation](/toolchain/sozo/).
