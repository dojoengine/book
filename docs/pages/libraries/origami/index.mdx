...
While Origami focuses on game-specific primitives, developers should also consider [Alexandria](/libraries/alexandria) for general Cairo utilities that complement Origami's game-focused functionality.
