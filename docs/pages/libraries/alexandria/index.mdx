...
For game development in Dojo, consider pairing Alexandria's comprehensive mathematical utilities with [Origami](/libraries/origami), which provides game-specific mathematical primitives designed specifically for onchain games.
