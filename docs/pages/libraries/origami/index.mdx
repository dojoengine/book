...
For advanced mathematical computations that complement these game development primitives, consider also using [Alexandria's extended math library](../alexandria).
