...
It should be noted that contract functions define the game logic.
Rather than implementing the logic in systems, we are implementing it in a contract.

## Compile your project

Now try `sozo build` to build.

Complied? Great! then let's move on.
