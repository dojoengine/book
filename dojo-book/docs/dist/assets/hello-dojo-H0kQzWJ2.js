...
`,i.jsx(s.span,{"data-line":"",children:i.jsx(s.span,{children:"// Retrieve the player's move data, e.g., how many moves they have left."})}),`
`,i.jsx(s.span,{"data-line":"",children:i.jsx(s.span,{children:"let moves = get!(world, player, (Moves));"})})]})})}),`
`,i.jsxs(s.p,{children:["Here we use ",i.jsx(s.code,{children:"get!"})," ",i.jsx(s.a,{href:"/cairo/commands",children:"command"})," to retrieve the ",i.jsx(s.code,{children:"Position"})," and ",i.jsx(s.code,{children:"Moves"})," model for the ",i.jsx(s.code,{children:"player"})," entity, which is the address of the caller."]}),`
...
`,i.jsx(s.span,{"data-line":"",children:i.jsx(s.span,{children:"    )"})}),`
`,i.jsx(s.span,{"data-line":"",children:i.jsx(s.span,{children:");"})})]})})}),`
`,i.jsxs(s.p,{children:["Here we use the ",i.jsx(s.code,{children:"set!"})," ",i.jsx(s.a,{href:"/cairo/commands",children:"command"})," to set the ",i.jsx(s.code,{children:"Moves"})," and ",i.jsx(s.code,{children:"Position"})," models for the ",i.jsx(s.code,{children:"player"})," entity."]}),`
...
`,i.jsxs(s.p,{children:["Let's discuss the ",i.jsx(s.code,{children:"Scarb.toml"})," file in the project. This file contains environment variables that make running CLI commands in your project a breeze (read more about it ",i.jsx(s.a,{href:"/cairo/config",children:"here"}),"). Make sure your file specifies the version of Dojo you have installed! In this case version ",i.jsx(s.code,{children:"0.4.4"}),"."]}),`
