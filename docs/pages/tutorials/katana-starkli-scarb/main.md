...
_Before starting, we recommend following the [Katana Getting Started guide](/toolchain/katana) to gain a basic understanding of katana, starkli and scarb._

For comprehensive Dojo-specific deployment patterns and framework fundamentals, see the [Dojo Starter tutorial](/tutorials/dojo-starter).
