...
_Before starting recommend following the [dojo-starter tutorial](/tutorials/dojo-starter) to gain a basic understanding of Dojo._
...
If you are not familar with model syntax in Dojo, see the [Models guide](/framework/models).
...
It should be noted that contract functions are the implementation methods.
Rather than implementing the game logic in systems, we are implementing it in a contract.
