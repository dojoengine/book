...
![Dojo Feature Matrix](/feature-matrix.png)
...
Katana serves as your local development environment, providing fast block times and instant transaction finality for rapid iteration.
...
Torii watches your world contract and maintains a synchronized view of all entities and events, exposing them through multiple query interfaces.
...
Sozo handles everything from building your Cairo contracts to deploying your world and executing system calls.

[Read more about Sozo](/toolchain/sozo)

## Saya Settlement Layer

Saya is a data availability layer that enables proving and settling of state transitions.
It bridges the gap between local development and production deployment by providing cryptographic proofs of state changes.
