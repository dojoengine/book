...
For detailed tool configuration information and priority settings, see the [toolchain configuration section](./understanding-the-toolchain#tool-configuration).
