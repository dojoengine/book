...
description: Learn the essential development workflow for building Dojo applications efficiently.
---
...
For a comprehensive development environment setup guide, see the [first app tutorial](./your-first-dojo-app).
The tutorial provides detailed terminal setup instructions and troubleshooting context for getting your development environment running smoothly.
...
For complete working examples of models and systems, see the [spawn-and-move example](./your-first-dojo-app) in the first app tutorial.
...
For more advanced toolchain capabilities and performance optimization techniques, see [Understanding the Toolchain](./understanding-the-toolchain).
Ready to explore what comes next in your journey? Continue to [Next Steps](./next-steps) to discover advanced topics, deployment strategies, and community resources.
