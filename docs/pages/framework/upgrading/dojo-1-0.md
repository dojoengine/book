...
For more detailed information about permissions configuration and management, see the [World Permissions documentation](/framework/world/permissions).
...
For more comprehensive testing documentation, see the [Testing documentation](/framework/testing).

## Configuration

For detailed configuration options including profile management, world settings, namespace configuration, permissions, and environment-specific settings, see the [Dojo Configuration documentation](/framework/configuration).
