...
1. **Default namespace**: All Dojo resources not explicitly mapped use this namespace
...
For more details on permission management, see [World Permissions](/framework/world/permissions).
