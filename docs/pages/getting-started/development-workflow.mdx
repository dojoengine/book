...
For detailed instructions on setting up your development environment with Katana, Sozo, and Torii, see the [Your First Dojo App tutorial](./your-first-dojo-app).

Once you have your tools running, you can start developing:
...
For detailed information about managing different deployment environments and tool configuration, see the [Understanding the Toolchain guide](./understanding-the-toolchain).
