...
For detailed Katana configuration options, see the [Katana configuration guide](../katana/configuration).
...
If you haven't already, consult the [Herodotus guide](./index) to get an account and an API key.
