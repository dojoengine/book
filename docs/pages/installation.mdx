...
You can get up-and-running in just a few steps, and be building provable applications in no time.
...
For a comprehensive understanding of Dojo's capabilities, see the [Dojo overview](/overview).
...
The Dojo toolchain consists of a Cairo framework and three Rust-based tools: `katana`, `torii`, and `sozo`.
...
For additional troubleshooting information, see our [FAQ](/faq).
