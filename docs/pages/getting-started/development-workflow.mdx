...
For a complete development environment setup including the three-terminal configuration and automation scripts, see [Understanding the Toolchain](./understanding-the-toolchain).
