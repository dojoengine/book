## File to edit: getting-started/understanding-the-toolchain.mdx

# Understanding the Toolchain

Now that you have built your first Dojo app, let us explore the tools that made it possible.
...
Let us make a query to retrieve all the instances of the `Position` model.
...
Here is the typical development flow:
...
- Verify you are in a Dojo project directory (look for `Scarb.toml`)
- Check that you are using the correct account address and private key

## Next Steps

Now that you understand the toolchain, you are ready to learn about the [development workflow](/getting-started/development-workflow) and start building more complex applications.
