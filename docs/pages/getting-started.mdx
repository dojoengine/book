...
description: Learn how to install and set up Dojo, including prerequisites and installation methods using dojoup or asdf.
---
...
```sh
asdf set --home dojo latest       # Set globally
asdf set --parent dojo 1.0.0      # Set locally in your project directory
```
