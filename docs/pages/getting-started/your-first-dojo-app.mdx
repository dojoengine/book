...
description: Create your first Dojo project from scratch and deploy it locally. Learn basic ECS concepts and use the development tools.
---
...
For detailed information about each tool, see [Understanding the Toolchain](./understanding-the-toolchain).

| Tool       | Purpose                         | Terminal   |
| ---------- | ------------------------------- | ---------- |
| **Katana** | Local Starknet sequencer        | Terminal 1 |
...
First, start [Katana](./understanding-the-toolchain#katana-local-starknet-sequencer), Dojo's high-performance sequencer:
...
In a new terminal, run the following command using [Sozo](./understanding-the-toolchain#sozo-build-and-deployment-tool), Dojo's build tool.
...
In a third terminal you'll start [Torii](./understanding-the-toolchain#torii-indexer-and-api-server), Dojo's indexer:
...
4. **Used the Toolchain**:
    - Katana provided a local Starknet sequencer
