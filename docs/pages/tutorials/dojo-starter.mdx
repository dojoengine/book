...
If not, please refer to the [installation](/installation.mdx) section and the [Cairo book](https://book.cairo-lang.org).
:::
...
Running the command mentioned above starts a [Torii](/toolchain/torii) indexer on your local machine.
...
For detailed GraphQL query examples and subscription setup, see the [React quickstart guide](/tutorials/react).
...
For frontend development, check out the [React quickstart tutorial](/tutorials/react) to learn how to build interactive clients.
