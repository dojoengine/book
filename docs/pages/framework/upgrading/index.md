...
### [Dojo 1.x](/framework/upgrading/dojo-1-0)
...
### [Dojo 1.7.x](/framework/upgrading/dojo-1-7)
...
For detailed guidance on upgrading your models and handling data migrations, see the [model upgrades guide](/framework/models/upgrades).
