...
It provides a set of powerful tools and libraries that enable game developers to create complex, engaging, and secure onchain games.
...
For general-purpose algorithms and utilities that complement these game-specific features, see [Alexandria](/libraries/alexandria).
...
For more advanced mathematical functions and algorithms, consider using [Alexandria Math](/libraries/alexandria) alongside these game-specific primitives.
