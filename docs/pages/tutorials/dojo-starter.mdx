...
To accomplish this, we have to execute `spawn` function from `actions` system.
...
Now that you have a working Dojo world, let's connect it to a React client application.
This section will guide you through setting up a development environment and connecting your frontend to your deployed Dojo world.

### Prerequisites

Before you can interact with the Dojo world from your React client, make sure you have:

- [Dojo CLI installed](/installation)
- Your local development network is running
- Your world is deployed and indexed

### Validation

First, validate that your development environment is working:

1. **Katana is running**: Make sure you can see the development network is active:
...
2. **Your world is deployed**: Check you have a world address from `sozo migrate`.

3. **Torii is indexing**: Verify the GraphQL endpoint is accessible at `http://localhost:8080/graphql`.
...
<div className="grid grid-cols-2 gap-8">
    <LinkCard
        ...
        description="Learn to build reactive client applications with Dojo."
