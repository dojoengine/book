...
While [Alexandria](../alexandria) serves as a general-purpose Cairo standard library, Origami complements it by providing game-specific functionality tailored for onchain gaming applications.
