...
In this case you would then use [`read_model`](../world/api.md#read_model) with both the player and location fields:
...
For more details on entity relationships and composition patterns, see the [entities guide](./entities).
