...
description: Learn the typical development workflow for building Dojo applications efficiently.
---
...
For initial environment setup instructions, see the [Your First Dojo App](./your-first-dojo-app) tutorial.
...
For more details on Sozo profiles and tool configurations, see [Understanding the Toolchain](./understanding-the-toolchain).
