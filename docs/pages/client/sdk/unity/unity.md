...
You should have a deep understanding of models in dojo if not checkout out models [here](/toolchain/framework/models.md) before continuing.

### What are Models in Dojo?

1. **Definition**: In Dojo, [models](/toolchain/framework/models.md) are essential state that represent various parts of [entities](/toolchain/framework/entities.md) within your game. They are the building blocks that make up the content of your game world. Read about [ECS](/tutorial/dojo-starter.md).
...
3. **Flexibility in Adding Models**:
   ...
   - You have the freedom to add as many [models](/toolchain/framework/models.md) as needed for your game's design and functionality.
   - It's vital, however, to ensure that these [models](/toolchain/framework/models.md) are consistent across both the Dojo and Unity. This means that for every model you have in Unity, there should be a corresponding model in your Dojo world.

4. **Future Developments**:

   - An important aspect to note is that in future versions of the Dojo-Unity integration, the process of adding and synchronizing [models](/toolchain/framework/models.md) will be further streamlined.
   - The plan is to have these [models](/toolchain/framework/models.md) auto-generated, which would significantly simplify the development process and reduce the manual effort required for synchronization.

5. **Importance of Understanding Models**:
   - Before diving into game development with Dojo in Unity, it’s recommended to have a solid understanding of how [models](/toolchain/framework/models.md) work in the Dojo environment.
...
In summary, [models](/toolchain/framework/models.md) are the bridge between the onchain (Dojo) and off-chain (Unity) aspects of your game.
...
Via toriiClient [models](/toolchain/framework/entities.md) are synced to Unity and are comprised of the models that you defined.
