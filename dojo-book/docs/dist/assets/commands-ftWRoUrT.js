...
`,e.jsxs(n.p,{children:["In the case that your model defines several keys as the ",e.jsx(n.a,{href:"/models",children:"resource example"}),", you must provide a value for each key."]}),`
