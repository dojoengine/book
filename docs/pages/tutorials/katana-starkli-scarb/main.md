...
description: "Learn to deploy and interact with Cairo smart contracts using Katana, starkli, and scarb"
---
...
For readers new to the Dojo framework, consider starting with the [Dojo Starter tutorial](/tutorials/dojo-starter) to understand the complete development workflow before focusing on contract deployment.
