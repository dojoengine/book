...
Before starting, we recommend following the [dojo-starter tutorial](/tutorials/dojo-starter) to gain a basic understanding of Dojo.
...
If you are not familiar with model syntax in Dojo engine, go back to the [Models chapter](/framework/models).
