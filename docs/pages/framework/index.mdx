...
[Models](./models) are Cairo structs that define your application's data structures.
...
[Systems](./systems) implement your application's business logic as Cairo contract functions.
...
The [World](./world) contract serves as the central coordinator, managing all models and systems.
