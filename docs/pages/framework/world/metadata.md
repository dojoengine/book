...
`sozo` does this by parsing the metadata defined in the Dojo [profile configuration](../configuration) `dojo_<PROFILE>.toml`.
...
For detailed IPFS configuration options, see the [configuration guide](../configuration).
