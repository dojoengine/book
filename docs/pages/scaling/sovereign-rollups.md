...
For information about Dojo's alternative scaling approach, see [Execution Sharding](/scaling/execution-sharding).
Both approaches enable developers to deploy customizable rollups with similar capabilities.
:::
