...
Dojo.godot is built on the [dojo.c foundation](/client/sdk/c), providing robust blockchain integration through a carefully designed C API that bridges Cairo and Starknet functionality with Godot's GDExtension system.
...
```gdscript
    ...
    dojo_session_account.create_from_subscribe(
        ...
        "https://api.cartridge.gg" # Cartridge Controller URL (defaults to this value)
    )
```
...
- **Cartridge Controller Integration**: Seamless wallet authentication and transaction signing.
