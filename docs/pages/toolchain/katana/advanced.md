...
On the [Torii](/toolchain/torii) side, a caching layer has been added to handle optimistic execution correctly.
Specifically:
...
For more binding generation workflows, see the [Sozo binding documentation](/toolchain/sozo/binding-generation).
:::
