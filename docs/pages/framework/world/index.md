...
The World contract implements a resource-based permission system.
For detailed information on permission types and management, see the [Permissions](/framework/world/permissions) guide.
