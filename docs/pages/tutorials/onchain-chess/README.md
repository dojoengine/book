...
description: "Build an on-chain chess game step by step to practice Dojo development"
---
...
You should also complete the [dojo-starter tutorial](../dojo-starter) to understand fundamental Dojo concepts.
...
If this seems too hard, don't worry!
This guide is for beginners.
If you know some basics about Cairo and Dojo, you're good.
We won't make a full chess game with all the rules.
We're keeping it simple.

## What after this guide?

We're making another guide to help design the frontend.
