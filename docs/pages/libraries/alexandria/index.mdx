...
For game-specific primitives and components, consider [Origami](../origami) which provides specialized crates designed specifically for Dojo game development on top of these general-purpose standard library functions.
