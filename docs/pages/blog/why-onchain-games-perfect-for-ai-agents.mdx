...
_The agent stack: query state via Torii, reason locally, execute via Controller_
...
_Building an agent for a Dojo game? Share what you're working on — we'd love to see it._
