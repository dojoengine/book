...
For more advanced mathematical operations and specialized data structures, see [Origami](./origami) which provides additional algebra and math utilities that work alongside Alexandria's core functionality.
