...
:::note
Follow the [dojo-starter tutorial](/tutorials/dojo-starter) or [your first dojo app guide](/getting-started/your-first-dojo-app) to set up your local environment.
:::
