...
For game-specific primitives and utilities, see the [Origami package](../origami).
...
For game-specific mathematical functions like collision detection or pathfinding, consider [Origami's algebra package](../origami#algebra).
