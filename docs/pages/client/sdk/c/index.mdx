...
For implementation details including the foundation-first approach and dual compilation strategy, see the [Dojo SDK Architecture overview](../index).

## What You Get

dojo.c is a "batteries included" SDK that bundles everything needed for Dojo game development:

### ToriiClient (Primary Focus)
...
- **Session Accounts**: Session-based accounts with policy-restricted permissions
...
Whether you're building Unity games, web applications, or custom integrations, it delivers consistent, reliable blockchain interaction with the convenience of an integrated ToriiClient, account management, and Starknet provider.
