...
_Before starting recommend following the [Dojo starter tutorial](/tutorials/dojo-starter) chapter to gain a basic understanding of the Dojo game._
...
If you are not familiar with model syntax in Dojo engine, go back to the [Models guide](/framework/models).
