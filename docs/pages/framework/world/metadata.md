...
The `name` of the resource, retrieved from its resource tag, is also stored in the resource metadata.
...
- `resource_id`: A unique identifier for the Dojo resource (world, model, contract, or event)
