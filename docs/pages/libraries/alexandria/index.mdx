...
Onchain data structures optimized for Starknet storage patterns
...
While Alexandria provides general utilities, developers should also consider [Origami](/libraries/origami) for game-specific primitives and algorithms tailored to onchain game development.
