...
- **System Calls**: Query contract view functions
...
- **Unity SDK** uses dojo.c via [C# P/Invoke](./c-bindings)
- **JavaScript SDK** uses dojo.c compiled to [WebAssembly](./wasm-bindings)
- **Unreal Engine** integrates dojo.c through [C++ bindings](./c-bindings)
