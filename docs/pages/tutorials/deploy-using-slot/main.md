...
Now, let's create a new project and initialize it with `sozo init`.
...
For comprehensive Torii deployment and configuration instructions, including debugging with Walnut and advanced configuration options, see the [mainnet deployment guide](/tutorials/deploy-to-mainnet/main).
