...
[Katana](/toolchain/katana) serves as the blockchain data source, providing the transaction history that Torii indexes:
...
For installation instructions covering all Dojo toolchain components, see the [Katana installation guide](/toolchain/katana).
