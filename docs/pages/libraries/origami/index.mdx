...
Each package focuses on a specific aspect of game development, from mathematical operations and procedural generation to economic mechanisms and security primitives.
...
Origami packages integrate seamlessly with Dojo's architecture and complement [Alexandria](../alexandria) for general mathematical operations beyond game-specific needs.
Each package is designed to work with Dojo's Entity Component System and can be combined for comprehensive game functionality.
