...
For comprehensive mathematical utilities that complement Origami's algebra features, see the [Alexandria](/libraries/alexandria) library which provides additional math operations and algorithms.
