...
> **Note**: The world itself is a special resource, with the resource selector `0`.
...
The World contract implements a resource-based permission system managed through our [permissions system](/framework/world/permissions).

For a complete understanding of permission types, resource hierarchy, and security patterns, see the [permissions documentation](/framework/world/permissions).
...
The World contract automatically emits [events](/framework/world/events) for all state changes, enabling automatic indexing by [Torii](/toolchain/torii) for your frontend applications.
...
For complete API documentation with examples, see the [API Reference](/framework/world/api).
