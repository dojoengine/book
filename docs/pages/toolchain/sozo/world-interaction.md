...
description: Commands for interacting with deployed Dojo worlds - executing systems, querying state, and managing permissions.
---
...
- **Type-aware calldata**: Supports Dojo's [calldata format](./index.md#data-format-reference)
