...
For a comprehensive understanding of the ECS architecture that powers Dojo, see the [detailed ECS theory section](/framework/models/entities#understanding-ecs-architecture).
...
The World contract serves as the central coordinator for all your application's models, systems, and permissions.
Learn more about the World contract in the [dedicated world documentation](/framework/world).
