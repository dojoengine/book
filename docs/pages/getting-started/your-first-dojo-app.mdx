...
- **spawn**: Create a new player at a random position
...
Now let's get the development tools running. You'll need three terminals:
...
`build` compiles your code, and `migrate` deploys it to Katana.
You'll see:
