...
For more details on events, see the [Events guide](/framework/world/events).
...
For comprehensive permission management details, see the [Permissions guide](/framework/world/permissions).
...
For more information on metadata management, see the [Metadata guide](/framework/world/metadata).
