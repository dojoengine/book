...
For comprehensive setup instructions and advanced configuration options, see the [Understanding the Toolchain](./understanding-the-toolchain) guide.
...
For detailed troubleshooting of tool-specific problems, see the [Troubleshooting Common Issues section](./understanding-the-toolchain#troubleshooting-common-issues) in the toolchain documentation.
...
For detailed configuration options for each tool, see the [Tool Configuration section](./understanding-the-toolchain#tool-configuration).
