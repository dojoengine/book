---
title: Welcome to Dojo 1.0.0
description: A comprehensive overview of Dojo 1.0.0's features, including core concepts, world interaction, permissions, events, and testing.
---
