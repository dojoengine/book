...
The ECS pattern consists of three core concepts: Entities (objects), Components (properties), and Systems (rules).
...
For a detailed exploration of how these work together with practical examples, see our [entities documentation](/framework/models/entities).
