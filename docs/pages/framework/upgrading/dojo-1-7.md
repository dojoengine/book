...
With Dojo 1.7, Sozo will instead began relying on procedural macros to implement specialized Dojo functionality.
With procedural macros, Dojo functionality can be accessed by Scarb at compile-time, rather than requiring separate pre-compilation.
