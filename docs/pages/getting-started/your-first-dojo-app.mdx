---
description: In this tutorial, you'll create your first Dojo project from scratch and deploy it locally.
---
...
| -------------------------------------------------- | ------------------------------- | ---------- |
| **[Katana](./understanding-the-toolchain#katana)** | Local blockchain sequencer      | Terminal 1 |
| **[Sozo](./understanding-the-toolchain#sozo)**     | Build and deploy your contracts | Terminal 2 |
| **[Torii](./understanding-the-toolchain#torii)**   | Index and serve game data       | Terminal 3 |
...
:::tip
Create a simple script to start all tools at once. Save this as `start-dev.sh`:
...
:::note
Some files and directories are omitted for simplicity
:::
...
pub mod actions {
    ...
    fn move_random(ref self: ContractState) {
        // Use the [Cartridge vRNG](https://docs.cartridge.gg/slot/vrng) to move in a random direction
    }
}
```
...
In a new terminal, run the following command using Sozo, Dojo's build tool:
