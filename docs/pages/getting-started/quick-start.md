...
For the language server to work properly, your local Scarb version must match Dojo's cairo version. To accomplish this, install it with the following command:
