...
**Client bindings** are code libraries that allow programs written in one language to interact with systems written in another language.
...
:::tip
For more binding generation workflows, see the [Sozo binding generation documentation](/toolchain/sozo/binding-generation).
:::
