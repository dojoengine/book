...
For basic model operations, you can read and write models directly:
...
For comprehensive model operations including field-level access, batch operations, and performance optimizations, see the [Model API Reference](/framework/models/api).
