...
- ✅ Built and deployed your first Dojo application with the [spawn-and-move example](./your-first-dojo-app)
- ✅ Understood the ECS architecture and [Dojo's toolchain](./understanding-the-toolchain)
...
1. **[On-chain Chess Tutorial](/tutorials/onchain-chess/README)**
    - Turn-based game mechanics
    - Complex state management
    - Game rule enforcement

2. **Advanced Tutorials** (Coming Soon)
